    ...
    def __init__(
      ...
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        vocab_size – The size of our vocabulary. This is needed to define 
            the size of our embedding layer, which will have shape [vocabulary_size, embedding_size].
        embedding_size – The dimensionality of our embeddings.
        filter_sizes – The number of words we want our convolutional filters 
            to cover. We will have num_filters for each size specified here. For example, [3, 4, 5] means that we will have filters that slide over 3, 4 and 5 words respectively, for a total of 3 * num_filters filters.
        num_filters – The number of filters per filter size (see above).
        """
        # Placeholders for input, output and dropout
        ### BRAM: placeholders need to be fed to the network when we execute it at train/ test time.
        ...
        pooled_outputs = []
        for i, filter_size in enumerate(filter_sizes): #Handige manier om te loopen: zowel index als value krijg je terug
